...
function customAssign(...objects) {
  ...
  for (const key in mergedObj) {
    ...
    if (typeof mergedObj[key] === "number") {
      // Заміна пробілів  на підкреслення!!!!!!!!!!!!
      mergedObj[key] = String(mergedObj[key]).replace(``, "_");
    }
  }
...
function checkAndPreventExtensions(obj) {
  ...
  const canAddProperties = Object.isExtensible(obj);
...
function convertArrayToObj(arr) {
  ...
  return Object.fromEntries(Object.entries(resultObj));
}
